...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productsList.add(new Products(1, "Japon Kiraz Çiçeği ","250 ml", "19.99 TL", R.drawable.prod2));
        productsList.add(new Products(2, "Afrika Mangolu Duş Jeli","350 ml", "25.99 TL", R.drawable.prod1));
        productsList.add(new Products(1, "Japon Kiraz Çiçeği","250 ml", "19.99 TL", R.drawable.prod2));
        productsList.add(new Products(2, "Afrika Mangolu Duş Jeli","350 ml", "25.99 TL", R.drawable.prod1));
        productsList.add(new Products(1, "Japon Kiraz Çiçeği","250 ml", "19.99 TL", R.drawable.prod2));
        productsList.add(new Products(2, "Afrika Mangolu Duş Jeli","350 ml", "25.99 TL", R.drawable.prod1));
